...
require 'orientdb-client-2.0-M2.jar'
require 'orientdb-core-2.0-M2.jar'
require 'orientdb-distributed-2.0-M2.jar'
require 'orientdb-enterprise-2.0-M2.jar'
require 'orientdb-graphdb-2.0-M2.jar'
# require 'orientdb-nativeos-1.7.8.jar'
require 'orientdb-object-2.0-M2.jar'
require 'orientdb-server-2.0-M2.jar'
