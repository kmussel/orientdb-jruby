...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/jars/orientdb-client-2.0-M2.jar",
    "lib/jars/orientdb-core-2.0-M2.jar",
    "lib/jars/orientdb-distributed-2.0-M2.jar",
    "lib/jars/orientdb-enterprise-2.0-M2.jar",
    "lib/jars/orientdb-graphdb-2.0-M2.jar",
    # "lib/jars/orientdb-nativeos-1.7.8.jar",
    "lib/jars/orientdb-object-2.0-M2.jar",
    "lib/jars/orientdb-server-2.0-M2.jar",
